const Classifier = require('./nbOOP.js');
const wish = require('wish');
describe('the file', () => {
    const classifier = new Classifier;
    classifier._songList.addSong('imagine',
        ['c', 'cmaj7', 'f', 'am', 'dm', 'g', 'e7'], 0);
    classifier._songList.addSong('somewhereOverTheRainbow',
        ['c', 'em', 'f', 'g', 'am'], 0);
    classifier._songList.addSong('tooManyCooks', ['c', 'g', 'f'], 0);
    classifier._songList.addSong('iWillFollowYouIntoTheDark',
        ['f', 'dm', 'bb', 'c', 'a', 'bbm'], 1);
    classifier._songList.addSong('babyOneMoreTime',
        ['cm', 'g', 'bb', 'eb', 'fm', 'ab'], 1);
    classifier._songList.addSong('creep',
        ['g', 'gsus4', 'b', 'bsus4', 'c', 'cmsus4', 'cm6'], 1);
    classifier._songList.addSong('paperBag',
        ['bm7', 'e', 'c', 'g', 'b7', 'f', 'em', 'a', 'cmaj7', 'em7', 'a7', 'f7',
            'b'], 2);
    classifier._songList.addSong('toxic',
        ['cm', 'eb', 'g', 'cdim', 'eb7',
            'd7', 'db7', 'ab', 'gmaj7', 'g7'], 2);
    classifier._songList.addSong('bulletproof',
        ['d#m', 'g#', 'b', 'f#', 'g#m', 'c#'], 2);
    classifier.trainAll();
    it('classifies', () => {
